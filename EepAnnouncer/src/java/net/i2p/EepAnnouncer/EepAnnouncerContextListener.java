...
public class EepAnnouncerContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        spin = new spinner(me);
        t = new Thread(spin, "Seedless.EepAnnouncer.spinner");
        t.start();
        ...
        public void run() {
            ...
            if(goahead) {
                ...
                while(spinit) {
                    try {
                        loops++;
                        TunnelData tunnel = (new SeedlessContextListenerCore()).testB32NeoDatis(me, "EepAnnouncer.war");
                        if(tunnel != null) {
                            pop = new EepAnnouncer(tunnel.outToI2P, tunnel.dir, me, net.i2p.EepAnnouncer.Version.VERSION);
                            t = new Thread(pop, "Seedless.EepAnnouncer");
                            t.setDaemon(true);
                            t.start();
                            net.i2p.EepAnnouncer.Version.main(null);
                            System.out.println("EepAnnouncer.war: context initialized for " + me);
                            break;
                        } else {
                            try {
                                Thread.sleep(1000);
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        if(t != null) {
            ...
            if(pop != null) {
                ...
                (new SeedlessContextListenerCore()).zap(t, "EepAnnouncer.war");
            }
        }
    }
}
